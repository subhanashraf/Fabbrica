...
export default function Navbar(params,{ imagealt = "image not found" }) {
    const navbar = useRef();
        ...
        {/*1: section in navbar and  landing page */}
            <div className="relative overflow-hidden w-full h-screen">
                ...
                <header className=" header fixed lg:top-6 z-50 w-full h-20 bg-transparent  text-white flex  justify-between align-middle text-center px-5 md:px-10 lg:px-20 ">
                    ...
                    <div className=""><NavLink to="https://www.instagram.com/lafabbricaparis"><img className="w-6 h-6 md:w-6 md:h-6 lg:w-7 lg:h-7 mt-6 " src="https://raw.githubusercontent.com/subhanashraf/Fabbrica-website/main/public/image/image-removebg-preview%20(2).png" alt={imagealt} /></NavLink> </div>
                </header>
